                ...
                <div class="row">
                    <div class="col-12">
                        <div class="profile__content">
                            ...
                            <ul class="nav nav-tabs content__tabs content__tabs--profile" id="content__tabs" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button id="2-tab" data-bs-toggle="tab" data-bs-target="#tab-2" type="button" role="tab"
                                        aria-controls="tab-2" aria-selected="false">Subscription</button>
                                </li>
                            ...
                            <button @click="handleLogout" class="profile__logout" type="button">
                                    ...
                                    <table class="dashbox__table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dashbox__table-text"><a href="details1.html">I Dream in
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dashbox__table-text"><a href="details1.html">Benched</a>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dashbox__table-text"><a href="details1.html">Whitney</a>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="dashbox__table-text"><a
                                                            href="details1.html">Blindspotting</a></div>
                                                </td>
                                                <td>
                        ...
                        <div class="col-12 col-lg-4 order-md-1 order-lg-2">
                            <div class="plan plan--premium">
                                ...
                                <button type="button" data-bs-toggle="modal" class="plan__btn"
                                    data-bs-target="#plan-modal"><span>Choose plan</span></button>
                            </div>
                        </div>
                        <!-- end price -->
